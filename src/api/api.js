...
export const accountAPI = {
    ...
    putPassword(passwordData) {
        return instance.put('account/password/change', passwordData, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
    ...
    postPasswordReset(passwordData) {
        return instance.post('account/password/reset', passwordData).then((data) => {
            return data.data
        })
    },

    postPasswordResetCode(code) {
        return instance.post('account/password/reset/code', code)
            .then((data) => {
                return { data: data.data }
            })
            .catch(err => {
    ...
    postSetPasswordReset(passwordData) {
        return instance.post('account/password/set', passwordData, {
            headers: {
    ...
    setPhoto(file) {
        ...
        return instance.put('account/profile/avatar', formData, {
            headers:
            {
                Authorization: 'Bearer ' + localStorage.getItem('Token'),
...
export const productAPI = {
    ...
    getReviewList(slug, queries) {
        return instance.get(`review/${slug}/list${queries ? queries : ''}`).then((data) => {
            return data.data
        })
    },
    ...
    createReview(slug, data) {
        ...
        return instance.post(`review/${slug}/create`, formData, {
            headers:
            {
                Authorization: 'Bearer ' + localStorage.getItem('Token'),
                'Content-Type': 'multipart/form-data'
...
export const orderAPI = {
    ...
    initOrder() {
        return instance.get(`order/init`, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
...
export const vendorsAPI = {
    vendorCreate(data) {
        ...
        return instance.post(`vendors/create`, formData, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
    ...
    getCabinet() {
        return instance.get(`vendors/cabinet`, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
    ...
    updatePhotoCabinet(file) {
        const formData = new FormData()
        formData.append("avatar", file)
        return instance.put(`vendors/avatar`, formData, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
    ...
    getTotalStatistics() {
        return instance.get(`vendors/statistics`, {
            headers: {
                Authorization: 'Bearer ' + localStorage.getItem('Token')
            }
        }).then((data) => {
